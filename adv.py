...
#  CREATES OPTIMUM PATH
#  loop through attempts, for each, create a player in starting room and an empty graph
for x in range(attempts):
    player = Player(world.starting_room)
    graph = {}

    fresh_room = {}
    # loop through each direction in current room
